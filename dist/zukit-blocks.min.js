(function () {
  ...
  */
  ...
  var _wp$components$a = wp.components,
      Path$1 = _wp$components$a.Path,
      G$1 = _wp$components$a.G,
      SVG$1 = _wp$components$a.SVG;
  ...
  function messageWithError(message) {
    ...
    return mdMessage.replace(/[:|.]\s*$/g, '') + ": <span class=\"zukit-data\">".concat(value, "</span>");
  ...
  var _lodash$g = lodash,
      ...
      set$1 = _lodash$g.set,
      unset = _lodash$g.unset,
      isPlainObject$3 = _lodash$g.isPlainObject,
      isFunction$2 = _lodash$g.isFunction,
      keys$2 = _lodash$g.keys,
      castArray$2 = _lodash$g.castArray,
      reduce$3 = _lodash$g.reduce;
  var _wp$element$8 = wp.element,
      useCallback$6 = _wp$element$8.useCallback,
      useReducer$1 = _wp$element$8.useReducer,
      useRef$1 = _wp$element$8.useRef; // Internal dependencies
  ...
  function optionsReducer(options, action) {
    switch (action.type) {
      case 'set':
        ...
        forEach$4(action.payload, function (val, key) {
          return val === null ? unset(options, key) : set$1(options, key, val);
      ...
      case 'pre-reset':
        ...
        if (isFunction$2(action.payload)) action.payload(options);
        return options;
  ...
  function useOptions(initialOptions, createNotice) {
    ...
    var setUpdateHook = useCallback$6(function (key, callback) {
      var keys = castArray$2(key); // create object for all keys {key: callback}

      var callbacks = reduce$3(keys, function (acc, val) {
  ...
  var _lodash$f = lodash,
      forEach$3 = _lodash$f.forEach,
      get$5 = _lodash$f.get,
      set = _lodash$f.set,
      isPlainObject$2 = _lodash$f.isPlainObject,
      isFunction$1 = _lodash$f.isFunction,
      mapValues = _lodash$f.mapValues;
  var _wp$element$7 = wp.element,
      createContext$1 = _wp$element$7.createContext;
      _wp$element$7.useContext;
      var useCallback$5 = _wp$element$7.useCallback,
      useReducer = _wp$element$7.useReducer; // Internal dependencies
  ...
  function panelsReducer(panels, action) {
    switch (action.type) {
      case 'set':
        ...
        forEach$3(action.payload, function (value, key) {
  ...
  function usePanels(initialPanels, createNotice) {
    ...
    var setPanel = useCallback$5(function (update) {
      if (!isPlainObject$2(update)) return; // forced to use the callback trick to get the current 'panels'
    ...
    var getPanel = useCallback$5(function (action) {
      ...
      switch (action.type) {
        ...
        case 'hidden':
          return action.id !== undefined && !get$5(panels, "".concat(action.id, ".value"));

        case 'value':
          return get$5(panels, "".concat(action.id, ".value"));

        case 'title':
          return get$5(panels, "".concat(action.id, ".label"));

        case 'falsely':
          return !checkDependency(get$5(panels, action.id), action.options);
  ...
  var _wp$element$6 = wp.element;
      _wp$element$6.useContext;
      var createContext = _wp$element$6.createContext;
  ...
  var _wp$components$9 = wp.components,
      PanelRow$1 = _wp$components$9.PanelRow,
      Button$6 = _wp$components$9.Button,
      Spinner$1 = _wp$components$9.Spinner;
  ...
  var ZukitActionButton = function ZukitActionButton(_ref, ref) {
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(PanelRow$1, null, /*#__PURE__*/React.createElement(Button$6, {
      ...
      ref: ref
    }, label, isLoading && /*#__PURE__*/React.createElement(Spinner$1, null))), help && /*#__PURE__*/React.createElement("p", {
  ...
  var _lodash$e = lodash,
      ...
      some$1 = _lodash$e.some;
  var __$7 = wp.i18n.__;
  var useCallback$4 = wp.element.useCallback;
  var _wp$components$8 = wp.components,
      createSlotFill = _wp$components$8.createSlotFill,
      PanelBody = _wp$components$8.PanelBody,
      PanelRow = _wp$components$8.PanelRow,
      Button$5 = _wp$components$8.Button,
      ExternalLink = _wp$components$8.ExternalLink,
      ToggleControl$2 = _wp$components$8.ToggleControl,
      Spinner = _wp$components$8.Spinner; // Internal dependencies
  ...
  var ZukitSidebar = function ZukitSidebar(_ref) {
    ...
    var moreItems = omitBy(more, function (item) {
      return isNil$6(item) || get$4(item, 'value', null) === null;
    });
    ...
    var hasActions = !isEmpty$5(pluginActions) || some$1(actions, ['hasMoreActions', true]);
    var hasPanels = !isEmpty$5(panels);
    var debugSet = get$4(debug, 'prefix', null);
    var debugOptions = debugSet ? get$4(debug, 'options') : null;
    var debugActions = debugSet ? omitBy(get$4(debug, 'actions'), isNil$6) : null;
    var hasDebug = (!isEmpty$5(debugActions) || !isEmpty$5(debugOptions)) && get$4(panels, "".concat(debugSet, ".value")) === true;

    var debugValue = function debugValue(k) {
      return get$4(options, debugSet ? "".concat(debugSet, ".").concat(k) : k);
    };

    var toggleDebugOptions = useCallback$4(function (key) {
      updateOptions(_defineProperty({}, "".concat(debugSet, ".").concat(key), !get$4(options, "".concat(debugSet, ".").concat(key))));
    }, [debugSet, options, updateOptions]);
    var resetAllOptions = useCallback$4(function () {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      initialOpen: false
    }, /*#__PURE__*/React.createElement(PanelRow, null, /*#__PURE__*/React.createElement("span", null, __$7('Version', 'zukit')), /*#__PURE__*/React.createElement("span", null, version)), /*#__PURE__*/React.createElement(PanelRow, null, /*#__PURE__*/React.createElement("span", null, __$7('Author', 'zukit')), /*#__PURE__*/React.createElement(ExternalLink, {
      href: link
    }, author)), hasMoreItems && map$4(moreItems, function (_ref2, moreKey) {
    ...
    }, __$7('Reset Plugin Options', 'zukit')))), hasActions && /*#__PURE__*/React.createElement(PanelBody, {
      title: __$7('Actions', 'zukit'),
      initialOpen: true
    }, map$4(pluginActions, function (_ref3, actionKey) {
      ...
      return /*#__PURE__*/React.createElement(ForwardButton, {
        ...
        help: help,
        value: value,
        isLoading: get$4(actionLoading, value),
        onClick: ajaxAction
      });
    }), /*#__PURE__*/React.createElement(MoreActionsSlot, null)), hasPanels && /*#__PURE__*/React.createElement(PanelBody, {
      title: __$7('Screen Options', 'zukit'),
      initialOpen: false
    }, map$4(panels, function (_ref4, panelKey) {
      ...
      initialOpen: false
    }, map$4(debugOptions, function (_ref5, key) {
    ...
    }), map$4(debugActions, function (_ref6, actionKey) {
      var _mergeClasses;
      ...
      return /*#__PURE__*/React.createElement(PanelRow, {
        ...
        className: mergeClasses('__plugin_actions', (_mergeClasses = {}, _defineProperty(_mergeClasses, color, color), _defineProperty(_mergeClasses, 'is-loading', get$4(actionLoading, value)), _mergeClasses)),
        icon: icon,
        isSecondary: true,
        onClick: function onClick() {
          return ajaxAction(value);
        }
      }, label, get$4(actionLoading, value) && /*#__PURE__*/React.createElement(Spinner, null)));
    })));
  };
  ...
  var _excluded$3 = ["id", "wp", "edit", "options", "panels", "info", "actions", "debug", "noticeUI", "noticeOperations"];
  // WordPress dependencies
  var _lodash$d = lodash,
      keys$1 = _lodash$d.keys,
      has$3 = _lodash$d.has,
      get$3 = _lodash$d.get,
      includes$4 = _lodash$d.includes,
      isEmpty$4 = _lodash$d.isEmpty,
      forEach$2 = _lodash$d.forEach,
      omit$1 = _lodash$d.omit,
      reduce$2 = _lodash$d.reduce,
      first = _lodash$d.first,
      castArray$1 = _lodash$d.castArray;
  var __$6 = wp.i18n.__;
  var compose$1 = wp.compose.compose;
  var RawHTML$2 = wp.element.RawHTML;
  var BlockIcon = wp.blockEditor.BlockIcon;
  var _wp$components$7 = wp.components,
      withNotices = _wp$components$7.withNotices,
      SlotFillProvider = _wp$components$7.SlotFillProvider;
  var _wp$element$5 = wp.element,
      ...
      useMemo$1 = _wp$element$5.useMemo; // Internal dependencies
  ...
  var ZukitSkeleton = function ZukitSkeleton(_ref) {
    var id = _ref.id,
        ...
        moreParams = _objectWithoutProperties(_ref, _excluded$3);

    var createNotice = noticeOperations.createNotice;

    var _useState = useState$3(info.more || {}),
        _useState2 = _slicedToArray(_useState, 2),
        moreInfo = _useState2[0],
        setMoreInfo = _useState2[1];

    var _useState3 = useState$3( // create object {action_value: state} from 'actions'
    reduce$2(actions, function (acc, val) {
      return acc[val.value] = false, acc;
    }, // from 'debug.actions'
    reduce$2(debug.actions, function (acc, val) {
      return acc[val.value] = false, acc;
    }, {}))),
    ...
    var resetOptions = useCallback$3(function (toBeReset) {
      var afterCallback = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
      ajaxAction('default_options', function (options) {
        var update = reduce$2(castArray$1(toBeReset), function (acc, value) {
          var resetValue = get$3(options, value, null);
    ...
    useEffect$3(function () {
      var infoKeys = reduce$2(moreInfo, function (acc, value) {
        forEach$2(castArray$1(get$3(value, 'depends', [])), function (val) {
      ...
      setUpdateHook(infoKeys, function () {
        ajaxAction('zukit_more_info', function (infoData) {
          setMoreInfo(get$3(infoData, 'more', {}));
        });
      });
    ...
    var pluginOptionsEdit = !EditComponent ? null : /*#__PURE__*/React.createElement(NoticesContext.Provider, {
      ...
      wp: wp,
      info: info,
      title: "".concat(info.title, " ").concat(__$6('Settings', 'zukit')),
      options: options,
    ...
    var pluginIcon = !info.icon ? null : /*#__PURE__*/React.createElement(BlockIcon, {
      icon: /*#__PURE__*/React.createElement(RawHTML$2, null, info.icon),
      showColors: true
    }); // custom appearance

    var backdropColor = get$3(info, 'colors.backdrop');
    var headerColor = get$3(info, 'colors.header');
    var titleColor = get$3(info, 'colors.title');
    return /*#__PURE__*/React.createElement("div", {
  ...
  compose$1([withNotices])(ZukitSkeleton);

  // WordPress dependencies
  var _lodash$c = lodash,
      includes$3 = _lodash$c.includes; // Internal dependencies
  ...
  var _lodash$b = lodash,
      get$2 = _lodash$b.get;
      _lodash$b.set;
      var map$3 = _lodash$b.map,
      has$2 = _lodash$b.has;
      _lodash$b.forEach;
      _lodash$b.defaultsDeep;
  var __$5 = wp.i18n.__;
  var _wp$element$4 = wp.element;
      _wp$element$4.render;
      var Fragment$1 = _wp$element$4.Fragment;
  var _wp$components$6 = wp.components,
      ToggleControl$1 = _wp$components$6.ToggleControl,
      SelectControl = _wp$components$6.SelectControl,
      Button$4 = _wp$components$6.Button; // Internal dependencies
  ...
  function toggleOption(toggleData, options, updateOptions) {
    ...
    var optionValue = function optionValue(k) {
      return get$2(options, fullKey(k));
    }; //  withPath ? `${withPath}.${k}` : k


    return map$3(toggleData, function (item, key) {
  ...
  function selectOption(optionData, options, updateOptions) {
    ...
    var value = get$2(options, selectId, defaultValue);
  ...
  var _wp$components$5 = wp.components,
      Path = _wp$components$5.Path,
      G = _wp$components$5.G,
      SVG = _wp$components$5.SVG; // Zukit Notice icons
  ...
  var _lodash$a = lodash,
      isArray$2 = _lodash$a.isArray,
      isPlainObject$1 = _lodash$a.isPlainObject,
      isNil$5 = _lodash$a.isNil,
      isNaN = _lodash$a.isNaN,
      forEach$1 = _lodash$a.forEach,
      includes$2 = _lodash$a.includes,
      trim$1 = _lodash$a.trim;
  var $ = jQuery; //-----------------------------------------------------------------------------]
  ...
  var _excluded$2 = ["condition", "wrap", "children"];
  // WordPress dependencies
  ...
  var _excluded$1 = ["className", "columns", "isSecondary", "isSmall", "withoutControl", "fillMissing", "fillNull", "recap", "options", "selectedItem", "transformValue", "beforeItem", "afterItem", "label", "help", "buttonStyle", "buttonClass", "withLabels", "withTooltip", "onClick"];
  // WordPress dependencies
  ...
  var SelectItemControl = function SelectItemControl(_ref) {
    ...
    var makeItem = function makeItem(_ref2) {
      ...
      return /*#__PURE__*/React.createElement(ConditionalWrap, {
        ...
        className: "is-null"
      }) : isSlot ? null : isFunction(transformValue) ? transformValue(value, label, style) : value), !isSlot && withLabels && /*#__PURE__*/React.createElement("div", {
  ...
  var _lodash$7 = lodash,
      isArray$1 = _lodash$7.isArray,
      isEmpty$3 = _lodash$7.isEmpty,
  ...
  var _wp$element$3 = wp.element,
      useState$2 = _wp$element$3.useState,
      useCallback$2 = _wp$element$3.useCallback,
      useMemo = _wp$element$3.useMemo;
  var _wp$url = wp.url,
  ...
  var ListInputControl = function ListInputControl(_ref) {
    ...
    var items = useMemo(function () {
      return isArray$1(value) ? value : isEmpty$3(value) ? [] : split(value, separator);
  ...
  var _wp$element$2 = wp.element,
      ...
      useEffect$2 = _wp$element$2.useEffect; // Internal dependencies
  ...
  var setValidatedValue = function setValidatedValue(val, withoutValues, fallbackValue, kind) {
    ...
    var value = isEmpty$2(withoutValues) ? val : uniqueValue(val, withoutValues, fallbackValue);
  ...
  var AdvTextControl = function AdvTextControl(_ref) {
    ...
    var onChangeValue = useCallback$1(function (value) {
      ...
      onUpdateValue(value);
    }, [onUpdateValue]); // sync 'temporaryValue' and 'value' what can happen if 'value' was changed outside the component и
  ...
  var _lodash$4 = lodash,
      ...
      repeat = _lodash$4.repeat,
      forEach = _lodash$4.forEach,
      sortBy = _lodash$4.sortBy;
  var __$2 = wp.i18n.__;
  var createHigherOrderComponent = wp.compose.createHigherOrderComponent;
  var _wp$data$1 = wp.data,
      withSelect = _wp$data$1.withSelect,
      useSelect$1 = _wp$data$1.useSelect; // Internal dependencies

  var ZUKIT_STORE = 'zukit/core';
  var FolderDepthSymbol = "\xA0";
  var FolderDepthShift = 4; // Custom Core Data state merger & getter -------------------------------------]
  ...
  var useCoreDataGeneric = function useCoreDataGeneric(key, params) {
    ...
    return isEmpty$1(data) ? null : data;
  ...
  var useSvgFromFileGeneric = function useSvgFromFileGeneric(name) {
    ...
    return isEmpty$1(svg) ? null : svg;
  }; // Get Folders/Galleries ------------------------------------------------------]
  // Higher-order component which add 'folders' to the original component

  var withFolders = createHigherOrderComponent(withSelect(function (select) {
    return {
      folders: select(ZUKIT_STORE).getValue('folders') || null
    };
  }), 'withFolders');
  var folderOptions = function folderOptions(folders) {
    var initialOption = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
    var sortedFolders = sortBy(folders, 'order'); // const idRefs = transform(folders, (acc, val, i) => { acc[val.id] = toInteger(i) });

    function folderOps(folder, ops, depth, parentId) {
      if (isNil$2(folder) || folder.parent_id !== parentId) return;
      ops.push({
        label: repeat(FolderDepthSymbol, depth * FolderDepthShift) + folder.title,
        value: folder.id
      });
      forEach(folder.childs, function (id) {
    ...
    var folderDepth = 0;
    var options = initialOption ? [initialOption] : [];
    forEach(sortedFolders, function (f) {
  ...
  var useFolders = function useFolders() {
    ...
    var _useSelect3 = useSelect$1(function (select) {
      return {
    ...
    return isEmpty$1(folders) ? null : folderId === null ? folders : get(folders, folderId, null);
  ...
  var useFolderOptions = function useFolderOptions() {
    var withInitial = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialOp;
    var folders = useFolders();
    return isEmpty$1(folders) ? emptyOps : folderOptions(folders, withInitial);
  ...
  var useGalleries = function useGalleries() {
    ...
    var _useSelect4 = useSelect$1(function (select) {
      return {
    ...
    return isEmpty$1(galleries) ? null : postId === null ? galleries : get(galleries, postId, null);
  }; // Get Loaders ----------------------------------------------------------------]
  // Higher-order component which add 'loaderHTML' to the original component

  var withLoaders = createHigherOrderComponent(withSelect(function (select, _ref) {
    var loader = _ref.loader;
    var loaderIndex = isNum(loader) ? loader : null;
    var loaderRaw = null;

    if (!isNil$2(loaderIndex)) {
    ...
    return {
      loaderHTML: isEmpty$1(loaderRaw) ? null : loaderRaw
    };
  ...
  var useLoaders = function useLoaders() {
    ...
    var _useSelect5 = useSelect$1(function (select) {
      return {
    ...
    return isEmpty$1(loaders) ? null : index === null ? loaders : get(loaders, index, null);
  };

  // WordPress dependencies
  var _lodash$3 = lodash,
      isNil$1 = _lodash$3.isNil,
      isArray = _lodash$3.isArray,
      isEmpty = _lodash$3.isEmpty,
      some = _lodash$3.some,
      reduce$1 = _lodash$3.reduce;
  var _wp$data = wp.data,
      useSelect = _wp$data.useSelect,
      useDispatch = _wp$data.useDispatch; // Internal dependencies
  ...
  function setupOptionsStore(router) {
    ...
    var _setupStore = setupStore(ZUKIT_OPTIONS_STORE),
    ...
    var useGetOption = function useGetOption(key) {
      ...
      return isNil$1(value) ? defaultValue : value;
    ...
    var useGetOptions = function useGetOptions(keys) {
      ...
      var optionKeys = isArray(keys) ? keys : emptyArray;

      var _useSelect2 = useSelect(function (select) {
        var _select = select(ZUKIT_OPTIONS_STORE),
            getValue = _select.getValue;

        var reduced = reduce$1(optionKeys, function (values, key) {
          values[key] = isNil$1(key) ? null : getValue(key);
          return values;
        }, {});
        return {
          gotOptions: reduced
      ...
      if (waitAll && some(gotOptions, isNil$1)) return null; // если пустой объект, то всегда возвращаем null
  ...
  var data = /*#__PURE__*/Object.freeze({
    ...
    useFolderOptions: useFolderOptions,
  ...
  var shortenMarkers = _.transform(config.markers, function (a, v, k) {
    return a["_".concat(k[0])] = v;
  });
  ...
  function renderComponent(maybeClientId) {
    var _b = shortenMarkers._b,
        _o = shortenMarkers._o;
    ...
    var id = (clientId !== null && clientId !== void 0 ? clientId : clientId2) ? " with ".concat(_b).concat(shortenId(clientId !== null && clientId !== void 0 ? clientId : clientId2)).concat(_b) : '';
    config.colors.render = true;
    setOpaqueColors('green');
    logAsOneString("".concat(_b).concat(component).concat(_b).concat(id, " ").concat(_o[0], "render").concat(_o[1]));
  ...
  function dataInComponent(data) {
    ...
    var _a = shortenMarkers._a,
        _b = shortenMarkers._b,
        _c = shortenMarkers._c;
    var component = componentName('dataInComponent');

    var keys = _.keys(data);

    var isSingleKey = keys.length === 1;
    var key = isSingleKey ? safe(_.first(keys)) : _.join(_.map(keys, safe), "".concat(_a, ", ").concat(_a));
    var value = isSingleKey ? data[_.first(keys)] : data;
    var altName = marker ? ":".concat(_c).concat(safe(String(marker))).concat(_c) : '';
    var message = "".concat(_b).concat(component).concat(_b).concat(altName, " ").concat(arrowSymbol, " value for ").concat(_a).concat(key).concat(_a);
  ...
  function infoInComponent(messageData) {
    ...
    var id = clientId ? " with ".concat(_b).concat(shortenId(clientId)).concat(_b) : '';
    var component = componentName(clientId ? 'infoInComponentWithId,infoInComponent' : 'infoInComponent');
    var info = "".concat(_b).concat(component).concat(_b).concat(id, " ").concat(arrowSymbol, " ").concat(safe(message));
  ...
  function useTraceUpdate(props) {
    ...
    var ref = useRef({
      ...
      id: trackClientId ? " with ".concat(_b).concat(shortenId(props)).concat(_b) : ''
    });
    ...
    useEffect(function () {
      ...
      if (propsChanged && !stateChanged) logAsOneString("Traced changes".concat(id, " ").concat(_p[0]).concat(key, " : props").concat(_p[1]));
      if (!propsChanged && stateChanged) logAsOneString("Traced changes".concat(id, " ").concat(_p[0]).concat(key, " : state").concat(_p[1]));
      if (propsChanged && stateChanged) logAsOneString("Traced changes".concat(id, " ").concat(_p[0]).concat(key, " : props & state").concat(_p[1]));
  ...
  function useMountUnmount() {
    ...
    useEffect(function () {
      ...
      logAsOneString("".concat(_b).concat(component).concat(_b, " ").concat(arrowSymbol, " ").concat(_c, "componentDidMount").concat(_c));
      return function () {
        config.colors.mount = true;
        logAsOneString("".concat(_b).concat(component).concat(_b, " ").concat(arrowSymbol, " ").concat(_o[0], "componentWillUnmount").concat(_o[1]));
      };
    }, []);
  ...
  var inverted = _.invert(fixed); // replace the characters that will be used for formatting (then we will restore them)


  var safe = function safe(s) {
    return s.replace(/[*_]/g, function (m) {
      return fixed[m];
    });
  }; // /[*_~{}]/g


  var restore = function restore(s) {
  ...
  var restoreToken = function restoreToken(t) {
    return "".concat(restore(t), "%c");
  };
  ...
  function parseWithColors(message, colors) {
    ...
    _.forEach(message, function (char) {
      if (char === _a) {
        ...
        format += "".concat(restore(token)).concat(_p[0], "%c");
        items.push(params);
        token = '';
      } else if (char === _p[1]) {
        format += restoreToken(token);
  ...
  function shortenId(props) {
    ...
    return forStorage ? shortened : shortened === 0 ? '?' : safe("\u2737\u2737\u2737-".concat(shortened));
  }
  ...
  function logSimplified(val) {
    {
      ...
      if (keys.length === 1) {
        var kind = _.isArray(val) ? "at ".concat(_a, "index").concat(_a) : "for ".concat(_a, "key").concat(_a);
        var message = ["value ".concat(kind, " ").concat(_p[0]).concat(safe(firstKey)).concat(_p[1])];
  ...
  function logAddedRemoved(added, removed) {
    ...
    if (addedKeys) {
      ...
      message += "added ".concat(_b).concat(addedKeys).concat(_b, " ").concat(_p[0]).concat(safe(_.join(keys, ', '))).concat(_p[1]).concat(removedKeys ? ', ' : '');
    }

    if (removedKeys) {
      var _keys = removed.length > compactKeysCount ? _.concat(_.take(removed, compactKeysCount), ['and more...']) : removed;

      message += "removed ".concat(_b).concat(removedKeys).concat(_b, " ").concat(_p[0]).concat(safe(_.join(_keys, ', '))).concat(_p[1]);
    }
  ...
  function logWasNow(was, now, keys) {
    ...
    if (changed && changed.length === 1) {
      ...
      var message = "".concat(chevronSymbol, "changed for ").concat(_b, "key").concat(_b, " ").concat(_p[0]).concat(safe(firstСhanged)).concat(_p[1]);
      ...
      logAsOneString("".concat(_c, "was").concat(_c));
      logSmart(wasValue);
      logAsOneString(changed ? "".concat(_c, "now").concat(_c, " changed for ").concat(_b, "keys").concat(_b, " ").concat(_p[0]).concat(safe(_.join(changed, ', '))).concat(_p[1]) : "".concat(_c, "now").concat(_c));
      logSmart(nowValue);

      if (_.isEqual(wasValue, nowValue)) {
        logAsOneString("".concat(_o[0], "Attention!").concat(_o[1], " ").concat(_b, "they are equal!").concat(_b));
      }
    }
  }
  ...
  function logChanges(keys, prevValues, values) {
    ...
    _.forEach(updated, function (key) {
      ...
      var message = "".concat(chevronSymbol).concat(_a).concat(safe(key)).concat(_a);
      if (isSimpleType(value)) logAsOneString(message, prevValues[key], arrowSymbol, value);else {
        if (_.isFunction(value)) {
          logAsOneString([message, "".concat(_p[0], "[function]").concat(_p[1])]);
        } else {
          ...
          if (!changed.length && !(addedKeys !== null && addedKeys !== void 0 && addedKeys.length) && !(removedKeys !== null && removedKeys !== void 0 && removedKeys.length)) {
            ...
            var keyMsg = "".concat(message, " @1 ").concat(_b, "@2").concat(_b, " ").concat(_p[0]).concat(safe(_.join(changed, ', '))).concat(_p[1]);
            ...
            if (_.isArray(value)) {
              ...
              if (_.has(value, '$$typeof')) {
                logAsOneString([message, "".concat(_p[0], "React Component").concat(_p[1])]);
              } else {
  ...
  function componentName() {
    ...
    var _findOnStack = findOnStack(skipFrames('componentName', prevFrames)),
        ...
        name = _findOnStack2[0]; // component name should start with UpperCase, replace simple underscore with "other" underscore
    ...
    var func = name.replace('/zu_blocks', '').replace(/[/]/g, '.'); // .replace(/_/g, '⎽')

    return "".concat(safe(func), "()");
  }
