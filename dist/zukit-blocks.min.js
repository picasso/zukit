(function () {
  ...
  */
  ...
  var _lodash$1 = lodash,
      map = _lodash$1.map,
      defaults = _lodash$1.defaults,
      upperFirst = _lodash$1.upperFirst,
      isFunction = _lodash$1.isFunction,
      isPlainObject$1 = _lodash$1.isPlainObject,
      every = _lodash$1.every,
      pick = _lodash$1.pick;
  ...
  var SelectItemControl = function SelectItemControl(_ref) {
    ...
    var makeItem = function makeItem(_ref2) {
      ...
      }, pick(additionalProps, buttonPossibleProps)), isFunction(transformValue) ? transformValue(value, label, style) : value), withLabels && /*#__PURE__*/React.createElement("div", {
    ...
    var recapOptions = isPlainObject$1(recap) ? defaults(recap, defaultRecapOptions) : defaultRecapOptions;
  ...
  var _lodash$2 = lodash,
      isArray$1 = _lodash$2.isArray,
      isEmpty = _lodash$2.isEmpty,
      isNil$1 = _lodash$2.isNil,
      map$1 = _lodash$2.map,
      pull = _lodash$2.pull,
      split = _lodash$2.split,
      join = _lodash$2.join,
  ...
  var ListInputControl = function ListInputControl(_ref) {
    ...
    var items = useMemo(function () {
      return isArray$1(value) ? value : isEmpty(value) ? [] : split(value, separator);
  ...
  var GET_DATA = TYPES.GET_DATA,
      SET_DATA = TYPES.SET_DATA,
      GET_OPTION = TYPES.GET_OPTION,
      SET_OPTION = TYPES.SET_OPTION,
      UPDATE_OPTIONS = TYPES.UPDATE_OPTIONS;
  var defaultState = {
    zudata: {
      albums: [],
      loaders: []
  ...
  var actions = {
    setZuData: function setZuData(key, value) {
      return {
        type: SET_DATA,
        key: key,
        value: value
    ...
    getZuData: function getZuData(path) {
      return {
        type: GET_DATA,
        path: path
      };
    ...
    updateOptions: /*#__PURE__*/regeneratorRuntime.mark(function updateOptions(options) {
      var path, data, result;
      return regeneratorRuntime.wrap(function updateOptions$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              path = requestURL('options');
              data = {
                keys: keys(options),
                values: options
              };
  ...
  registerStore(ZUKIT_STORE, {
      ...
      switch (action.type) {
        case SET_DATA:
          return _objectSpread2(_objectSpread2({}, state), {}, {
            zudata: _objectSpread2(_objectSpread2({}, state.zudata), {}, _defineProperty({}, action.key, action.value))
          });

        case SET_OPTION:
          return _objectSpread2(_objectSpread2({}, state), {}, {
            options: _objectSpread2(_objectSpread2({}, state.options), {}, _defineProperty({}, action.key, action.value))
          });

        case UPDATE_OPTIONS:
          return _objectSpread2(_objectSpread2({}, state), {}, {
            options: _objectSpread2(_objectSpread2({}, state.options), action.options)
          });
      }
    ...
    actions: actions,
    selectors: {
      getZuData: function getZuData(state, key) {
        var zudata = state.zudata;
        return zudata[key];
      },
      getOption: function getOption(state, key, defaultValue) {
        var options = state.options;
        return has$1(options, key) ? options[key] : defaultValue;
      }
    },
    controls: {
      GET_ZUDATA: function GET_ZUDATA(action) {
        return apiFetch$1({
          path: action.path
        });
      },
      GET_OPTION: function GET_OPTION(action) {
        return apiFetch$1({
          path: action.path
        });
      }
    ...
    resolvers: {
      getZuData: /*#__PURE__*/regeneratorRuntime.mark(function getZuData(key) {
        var path, value;
        return regeneratorRuntime.wrap(function getZuData$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                path = requestURL('zudata', {
                  key: key
                });
                _context2.next = 3;
                return actions.getZuData(path);

              case 3:
                value = _context2.sent;
                return _context2.abrupt("return", value ? actions.setZuData(key, value) : undefined);
      ...
      getOption: /*#__PURE__*/regeneratorRuntime.mark(function getOption(key, defaultValue) {
        var path, value;
        return regeneratorRuntime.wrap(function getOption$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                path = requestURL('option', {
                  key: key
                });
                _context3.next = 3;
                return actions.getOption(path);

              case 3:
                value = _context3.sent;
                return _context3.abrupt("return", actions.setOption(key, isNull(value) ? defaultValue : value));
  ...
  var _lodash$5 = lodash,
      ...
      isArray$2 = _lodash$5.isArray,
      isEmpty$1 = _lodash$5.isEmpty,
      get = _lodash$5.get,
      some = _lodash$5.some,
  ...
  var emptyArray = []; // Get Albums -----------------------------------------------------------------]
  // Higher-order component which add 'albums' to the original component

  var withAlbums = createHigherOrderComponent$1(withSelect(function (select) {
    return {
      albums: select(ZUKIT_STORE).getZuData('albums') || null
    };
  }), 'withAlbums'); // Custom hook which returns 'albums'

  var useAlbums = function useAlbums() {
    var _useSelect = useSelect(function (select) {
      return {
        albums: select(ZUKIT_STORE).getZuData('albums')
      };
    }, []),
        _useSelect$albums = _useSelect.albums,
        albums = _useSelect$albums === void 0 ? null : _useSelect$albums; // если пустой массив, то всегда возвращаем один и тот же объект


    return isEmpty$1(albums) ? emptyArray : albums;
  }; // Get Loaders ----------------------------------------------------------------]
  // Higher-order component which add 'loaderHTML' to the original component

  var withLoader = createHigherOrderComponent$1(withSelect(function (select, _ref) {
    var loader = _ref.loader,
        shape = _ref.shape;
    var loaders = select(ZUKIT_STORE).getZuData('loaders') || null;
    var loaderIndex = isNum(loader) ? loader : shape;
    return {
      loaderHTML: isEmpty$1(loaders) ? null : get(loaders, loaderIndex) || null
    };
  }), 'withLoader'); // Custom hook which returns 'loader' by 'index'

  var useLoader = function useLoader(index) {
    var _useSelect2 = useSelect(function (select) {
      return {
        loaders: select(ZUKIT_STORE).getZuData('loaders')
      };
    }, []),
        _useSelect2$loaders = _useSelect2.loaders,
        loaders = _useSelect2$loaders === void 0 ? null : _useSelect2$loaders; // если пустой массив или неправильный 'index', то возвращаем null


    return isEmpty$1(loaders) ? null : index === -1 ? loaders : get(loaders, index) || null;
  ...
  var useGetOption = function useGetOption(key) {
    ...
    var _useSelect3 = useSelect(function (select) {
      return {
        value: select(ZUKIT_STORE).getOption(key)
      };
    }, []),
        _useSelect3$value = _useSelect3.value,
        value = _useSelect3$value === void 0 ? null : _useSelect3$value;

    return isNil$3(value) ? defaultValue : value;
  ...
  var useGetOptions = function useGetOptions(keys) {
    ...
    var _useSelect4 = useSelect(function (select) {
      var _select = select(ZUKIT_STORE),
          getOption = _select.getOption;

      var reduced = reduce(optionKeys, function (values, key) {
        values[key] = isNil$3(key) ? null : getOption(key);
        return values;
      }, {});
      return {
        gotOptions: reduced
        ...
        _useSelect4$gotOption = _useSelect4.gotOptions,
        gotOptions = _useSelect4$gotOption === void 0 ? null : _useSelect4$gotOption;

    if (waitAll && some(gotOptions, isNil$3)) return null; // если пустой объект, то всегда возвращаем null
  ...
  var useUpdateOptions = function useUpdateOptions() {
    var _useDispatch = useDispatch(ZUKIT_STORE),
  ...
  var _lodash$6 = lodash,
      isNil$4 = _lodash$6.isNil;
  var RawHTML = wp.element.RawHTML; // Internal dependencies

  var Loader = function Loader(_ref) {
    var className = _ref.className,
        loaderHTML = _ref.loaderHTML;
    return isNil$4(loaderHTML) ? null : /*#__PURE__*/React.createElement(RawHTML, {
  ...
  var WithOptions = function WithOptions(_ref2) {
    var className = _ref2.className,
        ...
        shape = _ref2$shape === void 0 ? 'none' : _ref2$shape,
        duration = _ref2.duration,
        opacity = _ref2.opacity;
    var loaderHTML = useLoader(shape);
  ...
  var LoaderControl = function LoaderControl(_ref) {
    ...
    var onReveal = useCallback$2(function () {
      setRevealLoader(!revealLoader);
    }, [revealLoader]);
    var onChange = useCallback$2(function (loader) {
    ...
    var loaderOptions = reduce$1(_toConsumableArray(Array(loaders.length).keys()), function (options, val) {
      options.push({
        value: String(val),
        label: String(val)
      });
      ...
      value: 'none',
      label: __$3('Without Loader', 'zukit')
    }]);
    /* translators: loader selection */

    var noLoader = /*#__PURE__*/React.createElement("span", null, __$3('none', 'zukit'));
    return /*#__PURE__*/React.createElement(BaseControl$2, {
      className: mergeClasses(cprefix$1, className),
      label: label
      ...
      label: __$3('Reveal Loader', 'zukit'),
