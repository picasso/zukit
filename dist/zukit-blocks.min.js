(function () {
  ...
  */
  ...
  var _lodash$h = lodash,
      ...
      isFunction$5 = _lodash$h.isFunction,
      keys$2 = _lodash$h.keys,
      castArray$3 = _lodash$h.castArray,
      reduce$3 = _lodash$h.reduce;
  var _wp$element$9 = wp.element,
      useCallback$6 = _wp$element$9.useCallback,
      useReducer$2 = _wp$element$9.useReducer,
      useRef$2 = _wp$element$9.useRef; // Internal dependencies
  ...
  function optionsReducer(options, action) {
    switch (action.type) {
      ...
      case 'pre-reset':
        ...
        if (isFunction$5(action.payload)) action.payload(options);
        return options;
  ...
  function useOptions(initialOptions, createNotice) {
    var _useReducer = useReducer$2(optionsReducer, initialOptions),
        _useReducer2 = _slicedToArray(_useReducer, 2),
        options = _useReducer2[0],
        dispatch = _useReducer2[1];

    var hooks = useRef$2(null);
    ...
    var setUpdateHook = useCallback$6(function (key, callback) {
      var keys = castArray$3(key); // create object for all keys {key: callback}
  ...
  var _lodash$g = lodash,
      ...
      isFunction$4 = _lodash$g.isFunction,
      mapValues = _lodash$g.mapValues;
  var _wp$element$8 = wp.element,
      createContext$1 = _wp$element$8.createContext;
      _wp$element$8.useContext;
      var useCallback$5 = _wp$element$8.useCallback,
      useReducer$1 = _wp$element$8.useReducer; // Internal dependencies
  ...
  function panelsReducer(panels, action) {
    switch (action.type) {
      case 'set':
        ...
        if (isFunction$4(action.callback)) action.callback(panels); // we can't just return 'panels' with changes, we must return a new object
  ...
  var _wp$element$7 = wp.element;
      ...
      var createContext = _wp$element$7.createContext;
  var createHigherOrderComponent$2 = wp.compose.createHigherOrderComponent; // Context to make Notices be accessible by many components in the tree,
  // and at different nesting levels

  var NoticesContext = createContext();
  NoticesContext.displayName = 'ZukitNoticesContext';
  var withNoticesContext = createHigherOrderComponent$2(function (WrappedComponent) {
  ...
  var _wp$components$a = wp.components,
      ...
      Spinner$1 = _wp$components$a.Spinner;
  ...
  var _lodash$f = lodash,
      get$4 = _lodash$f.get,
      map$4 = _lodash$f.map,
      isEmpty$6 = _lodash$f.isEmpty,
      isNil$7 = _lodash$f.isNil,
      omitBy = _lodash$f.omitBy,
      pickBy = _lodash$f.pickBy,
      some$1 = _lodash$f.some;
  var __$7 = wp.i18n.__;
  ...
  var _wp$components$9 = wp.components,
      ...
      ExternalLink = _wp$components$9.ExternalLink,
      ToggleControl$2 = _wp$components$9.ToggleControl,
      Spinner = _wp$components$9.Spinner; // Internal dependencies
  ...
  var ZukitSidebar = function ZukitSidebar(_ref) {
    ...
    var moreItems = omitBy(more, function (item) {
      return isNil$7(item) || get$4(item, 'value', null) === null;
    });
    var pluginActions = pickBy(omitBy(actions, isNil$7), function (action) {
      return checkDependency(action, options);
    });
    var hasMoreItems = !isEmpty$6(moreItems); // either we have actions to display or there is an indication that the 'ZukitMoreActions' slot will be used

    var hasActions = !isEmpty$6(pluginActions) || some$1(actions, ['hasMoreActions', true]);
    var hasPanels = !isEmpty$6(panels);
    var debugSet = get$4(debug, 'prefix', null);
    var debugOptions = debugSet ? get$4(debug, 'options') : null;
    var debugActions = debugSet ? omitBy(get$4(debug, 'actions'), isNil$7) : null;
    var hasDebug = (!isEmpty$6(debugActions) || !isEmpty$6(debugOptions)) && get$4(panels, "".concat(debugSet, ".value")) === true;
  ...
  ZukitSidebar.MoreActions = Fill$1;
  ZukitSidebar.ActionButton = ForwardButton;

  var _excluded$4 = ["id", "wp", "edit", "options", "panels", "info", "actions", "debug", "noticeUI", "noticeOperations"];
  // WordPress dependencies
  var _lodash$e = lodash,
      ...
      reduce$2 = _lodash$e.reduce,
      first = _lodash$e.first,
      castArray$2 = _lodash$e.castArray;
  var __$6 = wp.i18n.__;
  ...
  var _wp$element$6 = wp.element,
      useState$3 = _wp$element$6.useState,
      useCallback$3 = _wp$element$6.useCallback,
      useEffect$3 = _wp$element$6.useEffect,
      useMemo$1 = _wp$element$6.useMemo; // Internal dependencies
  ...
  function editorClasses(element) {
    ...
    if (isEmpty$5(element)) {
      var ver = isEmpty$5(wp) ? '' : wp.replace(/\./g, '_');
  ...
  var ZukitSkeleton = function ZukitSkeleton(_ref) {
    var id = _ref.id,
        ...
        moreParams = _objectWithoutProperties(_ref, _excluded$4);
    ...
    var resetOptions = useCallback$3(function (toBeReset) {
      ...
      ajaxAction('default_options', function (options) {
        var update = reduce$2(castArray$2(toBeReset), function (acc, value) {
    ...
    useEffect$3(function () {
      var infoKeys = reduce$2(moreInfo, function (acc, value) {
        forEach$3(castArray$2(get$3(value, 'depends', [])), function (val) {
  ...
  compose$2([withNotices])(ZukitSkeleton);
  ...
  var _lodash$c = lodash,
      get$2 = _lodash$c.get;
      _lodash$c.set;
      var map$3 = _lodash$c.map,
      has$2 = _lodash$c.has;
      _lodash$c.forEach;
      _lodash$c.defaultsDeep;
  var __$5 = wp.i18n.__;
  var _wp$element$5 = wp.element;
      _wp$element$5.render;
      var Fragment$1 = _wp$element$5.Fragment;
  ...
  var _lodash$b = lodash,
      isArray$2 = _lodash$b.isArray,
      isPlainObject$2 = _lodash$b.isPlainObject,
      isNil$6 = _lodash$b.isNil,
      isNaN = _lodash$b.isNaN,
      forEach$2 = _lodash$b.forEach,
  ...
  function attrWithClientId(clientId, prop, value) {
    ...
    if ($el.length) {
      ...
      if (isArray$2(prop)) {
        forEach$2(prop, function (val) {
          return $el.removeAttr(val);
        });
      } else if (isPlainObject$2(prop)) {
        forEach$2(prop, processAttr);
      } else {
  ...
  function observeMutation(selector, observer) {
    ...
    if ($node.length === 0 || isNil$6(observer)) {
  ...
  var ConditionalWrap = function ConditionalWrap(_ref) {
    ...
    if (condition) {
      if (isString$1(WrappingComponent)) {
  ...
  var _lodash$9 = lodash,
      map$2 = _lodash$9.map,
      defaults$2 = _lodash$9.defaults,
      upperFirst = _lodash$9.upperFirst,
      isFunction$3 = _lodash$9.isFunction,
  ...
  var _wp$components$5 = wp.components,
      BaseControl$2 = _wp$components$5.BaseControl,
      Tooltip$2 = _wp$components$5.Tooltip,
      Button$3 = _wp$components$5.Button,
      ButtonGroup = _wp$components$5.ButtonGroup; // Internal dependencies
  ...
  var SelectItemControl = function SelectItemControl(_ref) {
    ...
    var makeItem = function makeItem(_ref2) {
      ...
      return /*#__PURE__*/React.createElement(ConditionalWrap, {
        ...
        className: "is-null"
      }) : isSlot ? null : isFunction$3(transformValue) ? transformValue(value, label, style, more) : value), !isSlot && withLabels && /*#__PURE__*/React.createElement("div", {
    ...
    var recapOptions = isPlainObject$1(recap) ? defaults$2(recap, defaultRecapOptions) : defaultRecapOptions;
  ...
  var _lodash$8 = lodash,
      ...
      isEmpty$4 = _lodash$8.isEmpty,
      isNil$5 = _lodash$8.isNil,
      map$1 = _lodash$8.map,
      pull = _lodash$8.pull,
      split = _lodash$8.split,
      join = _lodash$8.join,
      includes$1 = _lodash$8.includes,
      has = _lodash$8.has;
  var __$4 = wp.i18n.__;
  var ENTER$1 = wp.keycodes.ENTER;
  var _wp$compose$1 = wp.compose,
      compose$1 = _wp$compose$1.compose,
      useInstanceId$1 = _wp$compose$1.useInstanceId;
  var _wp$components$4 = wp.components,
      BaseControl$1 = _wp$components$4.BaseControl,
      Button$2 = _wp$components$4.Button,
      TextControl$1 = _wp$components$4.TextControl,
  ...
  var ListInputControl = function ListInputControl(_ref) {
    ...
    var items = useMemo(function () {
      return isArray$1(value) ? value : isEmpty$4(value) ? [] : split(value, separator);
    ...
    var isСombined = (isNotEmptyLabel ? !isEmpty$4(items) : true) && (label || help);
  ...
  var isKind = function isKind(kind, value) {
    if (value === '' || isNil$4(kind)) return true;
  ...
  var setValidatedValue = function setValidatedValue(val, withoutValues, fallbackValue, kind) {
    ...
    var value = isEmpty$3(withoutValues) ? val : uniqueValue(val, withoutValues, fallbackValue);
  ...
  var AdvTextControl = function AdvTextControl(_ref) {
    ...
    var onEnter = useCallback$1(function (event) {
      ...
      if (keyCode === ENTER && isFunction$2(onKeyEnter)) {
        onKeyEnter();
      }
  ...
  function setupStore(params) {
    var storeParams = defaults$1({}, params, {
      name: null,
      stateKey: 'data',
      routes: {
        get: 'cuget',
  ...
  var _lodash$5 = lodash,
      isEmpty$2 = _lodash$5.isEmpty,
      isNil$3 = _lodash$5.isNil,
      get = _lodash$5.get,
      includes = _lodash$5.includes,
      repeat = _lodash$5.repeat,
      forEach$1 = _lodash$5.forEach,
      sortBy = _lodash$5.sortBy;
  var __$2 = wp.i18n.__;
  ...
  var _wp$data$2 = wp.data,
      ...
      useSelect$1 = _wp$data$2.useSelect; // Internal dependencies
  ...
  var useCoreDataGeneric = function useCoreDataGeneric(key, params) {
    ...
    return isEmpty$2(data) ? null : data;
  ...
  var useSvgFromFileGeneric = function useSvgFromFileGeneric(name) {
    ...
    return isEmpty$2(svg) ? null : svg;
  }; // Get Folders/Galleries ------------------------------------------------------]
  // Higher-order component which add 'folders' to the original component

  var withFolders = createHigherOrderComponent$1(withSelect$1(function (select) {
    return {
  ...
  var folderOptions = function folderOptions(folders) {
    ...
    function folderOps(folder, ops, depth, parentId) {
      if (isNil$3(folder) || folder.parent_id !== parentId) return;
      ops.push({
        label: repeat(FolderDepthSymbol, depth * FolderDepthShift) + folder.title,
        value: folder.id
      });
      forEach$1(folder.childs, function (id) {
    ...
    forEach$1(sortedFolders, function (f) {
  ...
  var useFolders = function useFolders() {
    ...
    return isEmpty$2(folders) ? null : folderId === null ? folders : get(folders, folderId, null);
  ...
  var useFolderOptions = function useFolderOptions() {
    ...
    return isEmpty$2(folders) ? emptyOps : folderOptions(folders, withInitial);
  ...
  var useGalleries = function useGalleries() {
    ...
    return isEmpty$2(galleries) ? null : postId === null ? galleries : get(galleries, postId, null);
  }; // Get Loaders ----------------------------------------------------------------]
  // Higher-order component which add 'loaderHTML' to the original component

  var withLoaders = createHigherOrderComponent$1(withSelect$1(function (select, _ref) {
    var loader = _ref.loader;
    var loaderIndex = isNum(loader) ? loader : null;
    var loaderRaw = null;

    if (!isNil$3(loaderIndex)) {
    ...
    return {
      loaderHTML: isEmpty$2(loaderRaw) ? null : loaderRaw
    };
  ...
  var useLoaders = function useLoaders() {
    ...
    return isEmpty$2(loaders) ? null : index === null ? loaders : get(loaders, index, null);
  };

  // WordPress dependencies
  var _lodash$4 = lodash,
      isNil$2 = _lodash$4.isNil,
      isArray = _lodash$4.isArray,
      isEmpty$1 = _lodash$4.isEmpty,
      isFunction$1 = _lodash$4.isFunction,
      isPlainObject = _lodash$4.isPlainObject,
      some = _lodash$4.some,
      reduce$1 = _lodash$4.reduce,
      defaults = _lodash$4.defaults;
  var _wp$data$1 = wp.data,
      useSelect = _wp$data$1.useSelect,
      useDispatch = _wp$data$1.useDispatch;
  var _wp$element$2 = wp.element,
      useRef$1 = _wp$element$2.useRef,
      useReducer = _wp$element$2.useReducer; // Internal dependencies
  var emptyArray = []; // Custom hooks ---------------------------------------------------------------]
  ...
  function useRefInit(func) {
    var params = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
    var ref = useRef$1(null);
    if (ref.current === null && isFunction$1(func)) ref.current = func(params);
    return ref;
  }
  function useRefDefaults(params) {
    var defaultValues = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    var ref = useRef$1(null);

    if (ref.current === null && params) {
      var value = isPlainObject(params) ? defaults({}, params, defaultValues) : params;
      ref.current = value;
    }
  ...
  function setupOptionsStore(router) {
    ...
    var useGetOption = function useGetOption(key) {
      ...
      return isNil$2(value) ? defaultValue : value;
    ...
    var useGetOptions = function useGetOptions(keys) {
      ...
      var _useSelect2 = useSelect(function (select) {
        ...
        var reduced = reduce$1(optionKeys, function (values, key) {
          values[key] = isNil$2(key) ? null : getValue(key);
          return values;
        }, {});
        return {
          gotOptions: reduced
      ...
      if (waitAll && some(gotOptions, isNil$2)) return null; // если пустой объект, то всегда возвращаем null

      return isEmpty$1(gotOptions) ? null : gotOptions;
  ...
  var data = /*#__PURE__*/Object.freeze({
    ...
    useRefInit: useRefInit,
    useRefDefaults: useRefDefaults,
  ...
  var Loader = function Loader(_ref) {
    ...
    return isNil$1(loaderHTML) ? null : /*#__PURE__*/React.createElement(RawHTML$1, {
  ...
  var _wp$components$2 = wp.components,
      ...
      ToggleControl = _wp$components$2.ToggleControl; // Internal dependencies
  ...
  var ModalMessage = function ModalMessage(_ref) {
    ...
    }, map(castArray$1(children || []), function (button, key) {
  ...
  var _wp$data = wp.data,
      ...
      withDispatch = _wp$data.withDispatch; // Internal dependencies
  ...
  var withSidebarPlugin = createHigherOrderComponent(function (WrappedComponent) {
    return function (ownProps) {
      var className = ownProps.className,
          ...
          titleProps = ownProps.titleProps,
          ...
          initialOpen = _ownProps$initialOpen === void 0 ? true : _ownProps$initialOpen; // we pass to the 'WrappedComponent' a function that allows us to update the parent component

      var forceUpdate = useForceUpdater(); // when 'allowEmptyValues' is false and 'metaValues' are empty (undefined or null) - nothing will be rendered

      if (!allowEmptyValues && (isNil(metaValues) || isEmpty(filter(metaValues)))) return null; // if 'title' is a React component - then create the component with 'titleProps'

      var titleElement = isFunction(title) ? title(isFunction(titleProps) ? titleProps() : titleProps) : title;
      if (slot === 'status') return /*#__PURE__*/React.createElement(PluginPostStatusInfo, null, /*#__PURE__*/React.createElement(WrappedComponent, _extends({
      ...
      if (slot === 'sidebar') return /*#__PURE__*/React.createElement(React.Fragment, null, moreItem && /*#__PURE__*/React.createElement(PluginSidebarMoreMenuItem, {
        target: name,
        icon: moreIcon
      }, moreTitle || titleElement), /*#__PURE__*/React.createElement(PluginSidebar, {
        name: name,
        title: titleElement,
        icon: icon,
        className: className
        ...
        forceUpdate: forceUpdate
      }, ownProps)))); // otherwise fill in the requested slot
  ...
  var withPlugin = function withPlugin(pluginProps) {
    return compose([// get Plugin props
    createHigherOrderComponent(function (WrappedComponent) {
      return function (ownProps) {
        return /*#__PURE__*/React.createElement(WrappedComponent, _extends({}, ownProps, pluginProps));
      };
    }, 'withPlugin'), withSidebarPlugin]);
  };
  var withPluginMeta = function withPluginMeta(pluginProps) {
    return compose([// get plugin props
    createHigherOrderComponent(function (WrappedComponent) {
      return function (ownProps) {
        return /*#__PURE__*/React.createElement(WrappedComponent, _extends({}, ownProps, pluginProps));
      };
    }, 'withPluginAndMeta'), // get meta values by keys
    withSelect(function (select, _ref) {
      ...
      var metaValues = transform(castArray(metaKeys), function (values, key) {
  ...
  var plugins = /*#__PURE__*/Object.freeze({
    __proto__: null,
    withSidebarPlugin: withSidebarPlugin,
    withPlugin: withPlugin,
    withPluginMeta: withPluginMeta
  });
