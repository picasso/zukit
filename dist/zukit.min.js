(function () {
  ...
  */
  ...
  var _lodash$h = lodash,
      ...
      isFunction$2 = _lodash$h.isFunction,
  ...
  var _lodash$g = lodash,
      ...
      isFunction$1 = _lodash$g.isFunction,
  ...
  var ListInputControl = function ListInputControl(_ref) {
    ...
    return /*#__PURE__*/React.createElement(BaseControl$1, {
      ...
      className: mergeClasses('components-animate__appear', 'is-from-top', '__input', {
  ...
  var _wp$element$3 = wp.element,
      ...
      useEffect$2 = _wp$element$3.useEffect; // Internal dependencies
